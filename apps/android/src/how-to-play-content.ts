...
export const HOW_TO_PLAY_SECTIONS: HowToPlaySection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Submit checks the equation and saves correct solutions on this device.',
    ],
  },
  {
...
export const HOW_TO_PLAY_DETAIL_CARDS: HowToPlayDetailCard[] = [
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-1.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-2.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-3.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-4.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-5.png'),
  ...
  {
    title: 'Check Stats',
    imageSource: require('../assets/how-to-play/instruction-6.png'),
  ...
  {
    title: 'Try Hard mode',
    imageSource: require('../assets/how-to-play/instruction-7.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-8.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-9.png'),
  ...
  },
  {
    ...
    imageSource: require('../assets/how-to-play/instruction-10.png'),
